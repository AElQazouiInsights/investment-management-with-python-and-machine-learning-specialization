...
- Widget routing checks: Run `node --test tests/test_widget_routing.mjs` to check per-editor widget export and generated Python arguments, including the random seed. Live browser rendering, slider transport, and performance still require browser verification.
