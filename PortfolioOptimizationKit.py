...
def show_gbm(
    ...
    """
    Plot the evolution of prices generated by a GBM.
    The method simply calls the *simulate_gbm_from_returns* function and plots the generated prices.
    This method is designed to be used together with the *interact* method from *ipywidgets*.
    """
...
def show_cppi_echart(
    ...
    """Simulate CPPI wealth paths and emit an ECharts payload for the docs frontend."""
    ...
    # Ensure the starting wealth is represented explicitly.
    ...
    if not risky_allocation.empty:
        risky_allocation = insert_first_row_df(risky_allocation, risky_allocation.iloc[0].to_dict())
